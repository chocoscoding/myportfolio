    ...
    return (
        <div className="about-body">
            ...
            <div className="links-cont">
                <a href="https://www.linkedin.com/in/oyetitimileyin/"><button className="links">Linkedin <FaLinkedin className="icons"/></button></a>
                <a href="https://github.com/chocoscoding"><button className="links">Github <FaGithub className="icons"/></button></a>
            </div>
            </div>
